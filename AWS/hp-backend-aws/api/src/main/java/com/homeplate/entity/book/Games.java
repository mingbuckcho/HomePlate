...
@Table(name = "games", uniqueConstraints = {
        @UniqueConstraint(
                name = "uk_game",
                columnNames = {"stadium_id", "game_start_at"}
        )
})
public class Games {
    @Id
    ...
    //setter
    public void update(Stadiums stadium, Teams home, Teams away, LocalDateTime gameStartAt, LocalDateTime ticketOpenAt, GameStatus gameStatus, int maxSeats) {
